...
__all__ = ['ScoreCAM', 'SSCAM', 'ISCAM', 'SSCAM_Input']
...
class ScoreCAM(_CAM):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(model, input_shape, **kwargs)
...
class SSCAM(ScoreCAM):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(model, batch_size, input_shape, **kwargs)
