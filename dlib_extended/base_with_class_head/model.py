...
from dlib_extended.base import initialization as init
from dlib_extended.utils.shared import count_params
...
class SegmentationModel(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        class_logits = self.classification_head(decoder_output)

        return masks_logits, class_logits
