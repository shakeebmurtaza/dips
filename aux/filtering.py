...
class GaussianFiltering(nn.Module):
    def __init__(self, blur_ksize: int, blur_sigma: float, device):
        ...
        or width. eg. 115. The larger the kernel is the larger the distortion
        will be.
        :param blur_sigma: float. variance of the Gaussian. eg. 105.5. the
        larger the variance is the larger the distortion will be.
        """
    ...
    def forward(self, images):
        ...
        N,C,H,W on the same device as this class. N: batch size, C: number of
        image channels, H, W are hieght and width of image.
        :return: filtered images on the same device, with same shape as input.
        """
...
def test_GaussianFiltering():
    ...
    set_seed(seed=seed)
    path_imng = join(root_dir, 'aux/data',
...
if __name__ == '__main__':
    ...
    # install: pip install kornia==0.6.1
